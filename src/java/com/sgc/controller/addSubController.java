...
import com.sgc.model.addMainClassificationDAO;
import com.sgc.model.addSubClassification;
import com.sgc.model.addSubClassificationDAO;
...
public class addSubController extends HttpServlet {
    ...
    addSubClassificationDAO ascDAO = new addSubClassificationDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ascDAO.saveSubClassification(asc);
